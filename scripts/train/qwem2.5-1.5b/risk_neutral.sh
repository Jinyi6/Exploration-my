...
N_NODE=1
EXPERIMENT_NAME=qwen3-1.7b-2gpu-PPO-risknuetral-qwen2.5
...
CRITIC_NUM_QUANTILES=51
CRITIC_QUANTILE_KAPPA=1.0
CRITIC_QUANTILE_MODE=c51
...
python3 -m verl.trainer.main_ppo \
    ...
    ++critic.risk_level=neutral \
    ++algorithm.risk_level=neutral \
