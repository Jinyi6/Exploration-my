...
N_NODE=1
EXPERIMENT_NAME=qwen3-1.7b-2gpu-PPO-distributional
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/mnt/shared-storage-user/liujinyi/test123/Qwen3-1.7B/snapshots/0060bc56d46589041c1048efd1a397421b1142b5  \
    critic.model.path=/mnt/shared-storage-user/liujinyi/test123/Qwen3-1.7B/snapshots/0060bc56d46589041c1048efd1a397421b1142b5 \
    ...
    actor_rollout_ref.actor.entropy_coeff=1e-5 \
